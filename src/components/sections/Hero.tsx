        ...
        <div className="relative z-20 mt-[0.8rem] w-full max-w-[34rem] md:mt-[1.35rem] lg:mt-[1.65rem]">
          ...
          <FadeInUp delay={0.4}>
            <div className="mt-[1.55rem] flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-[1.8rem]">
              <Link
                href="/#contacto"
                className="inline-flex min-h-[3rem] w-fit items-center justify-center gap-[0.95rem] rounded-[0.12rem] bg-accent px-[1.2rem] text-[15px] font-medium leading-none text-white transition-all hover:bg-accent-light focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background md:min-w-[13.4rem] md:text-[16px]"
              >
